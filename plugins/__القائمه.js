...
function clockString(ms) {
    ...
    return [h, m, s].map(v => v.toString().padStart(2, 0)).join(':')
            ...
            buttonParamsJson: '{"display_text":"معلومات البوت#","id":".معلومات-البوت"}'
                   ...
                   {
             name: "cta_url",
             buttonParamsJson: '{"display_text":"⌈📲╎قـنـاة الـمـطـور╎📲⌋","url":" https://whatsapp.com/channel/0029VanIroV7YScwYEsjNv1N  ","merchant_url":" https://whatsapp.com/channel/0029VanIroV7YScwYEsjNv1N "}'
                          }
                      ]
                  }
              }
