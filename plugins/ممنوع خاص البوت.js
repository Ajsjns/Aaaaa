...
export async function before(m, { conn, isAdmin, isBotAdmin, isOwner, isROwner }) {
    ...
    if (!m.isGroup) {
      ...
      if (bot.pmblocker && !isOwner && !isROwner) {
        ...
        await m.reply(`*[❗] مرحبًا @${m.sender.split`@`[0]}، يُمنع التحدث في الخاص مع البوت لهذا السبب سيتم حظرك.*\n\n*اذا كنت تريد تجربه البوت ادخل جروب البوت『  https://chat.whatsapp.com/EjHOx4CWDLtAtLPrAecTqq  』*\n\n*اذا كنت تريد ان تكلم مطور البوت هذا رقمي 『‏‪『+33760509044*`, false, { mentions: [m.sender] });
